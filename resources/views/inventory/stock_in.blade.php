...
@section('content')
    <div class="container">
        <div class="d-md-flex justify-content-md-between mb-4">
            <h1 class="header-text">Stock In</h1>
        </div>
        <div class="row">
            ...
            <div class="col d-block">
                ...
                <form method="POST" action="{{route('add_stock', ['id' => $product->product_id])}}">
                    ...
                    <div class="justify-content-between">
                        ...
                        <button class="primary-button px-md-5 px-3 me-2 float-end" onclick="return confirm('Are you sure you want to add stocks?')" type="submit">Confirm</button>
                    </div>
                </form>
            </div>
        <div>
