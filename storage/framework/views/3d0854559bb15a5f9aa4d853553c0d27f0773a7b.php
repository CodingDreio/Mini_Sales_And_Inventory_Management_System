...
<?php $__currentLoopData = $transaction; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $purchase): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div class="m-3">
        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-sm-7 col-md-7 col-lg-7 ">
                                <div class="float-start me-3 mb-3">
                                    <h6>Cashier: <?php echo e($user->first_name); ?>, <?php echo e($user->last_name); ?></h6>
                                    <h6>Sales Invoce No.: <?php echo e($purchase->sales_invoice_no); ?></h6>
                                    <h6 class="text-secondary">Vatable Sale: <span id="vatSale"><?php echo e($purchase->vatable_sale); ?></span></h6>
                                    <h6 class="text-secondary">VAT Amount: <span id="vatAmount"> <?php echo e($purchase->vat_amount); ?></span></h6>
                            ...
                            <div class="col-sm-5 col-md-5 col-lg-5">
                                <div class="float-end me-3 mb-3">
                                    <h5>Total Amount:</h5>
                                    <h2 class="ms-5" id="totalPrice"><?php echo e($purchase->total_price); ?></h2>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        <div id="purchaseForm" class="form-display-none">
                            <h5>Add orders</h5>
                                ...
                                <input type="text" id="transId" name="transID" value="<?php echo e($purchase->sales_report_id); ?>" hidden>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a href="<?php echo e(route('cancelPurchase',['id'=> $purchase->sales_report_id])); ?>" class="btn primary-btn">Submit</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="purModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="<?php echo e(route('completePurchase',['id'=> $purchase->sales_report_id])); ?>" method="post">
                    <?php echo csrf_field(); ?>
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <div class="float-end mb-3">
                            ...
                            <h3 id="amount" class="ms-5"><?php echo e($purchase->total_price); ?></h3>
                        </div>
                        <div class="input-group mb-3">
        ...
        function fetchOrders(){
            ...
            $.ajax({
                ...
                success:function(response){
                    ...
                    // <?php echo e(route("removeOrder",["id"=>'+item.order_id+'])); ?>
...
<?php echo $__env->make('layouts.cashier_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\3. Projects\Web Development\Laravel 8\PSale\resources\views/cashier/cashier_new_purchase.blade.php ENDPATH**/ ?>